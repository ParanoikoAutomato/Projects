 ...
 * @author LG
 */
public class pdBoard extends javax.swing.JFrame {

    /**
     * Creates new form pdBoard
     */
    public pdBoard() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pdBoard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
